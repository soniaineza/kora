- [ ] Inspect free-trial route/page (where Quiz is rendered with isSample=true)
- [ ] Update `src/components/Quiz.tsx` to start free-trial timer with a single “Start Timer” click
